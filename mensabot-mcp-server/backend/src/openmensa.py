"""
OpenMensa API v2 wrapper (synchronous).
Author: Tobias Veselsky

Features:
- Typed dataclasses for Canteen, Day, Meal, PriceInfo
- Graceful parsing of messy API responses
- Stable to_dict() output for MCP / LLM use
- Pagination support for /canteens and /days
- Centralized error handling with OpenMensaAPIError
"""
