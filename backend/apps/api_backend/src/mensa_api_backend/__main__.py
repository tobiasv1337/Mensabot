...
LLM_BASE_SYSTEM_PROMPT = (
    ...
    "Keep the length of your answers appropriate for a chatbot that gets used a lot on mobile. Be concise. The response should be short enough for chatbubbles on mobile devices.\n"
)
