...
from .dto import DietType, MealDTO, MenuDietFilter, MenuResponseDTO, MenuStatusDTO, PriceCategory
from .mappers import _meal_to_dto
from .meal_enrichment import _canonicalize_allergen_label
...
def fetch_single_menu(
    ...
    filtered_meals = _filter_meals([_meal_to_dto(m, price_category) for m in meals], diet_filter, exclude_allergens)
